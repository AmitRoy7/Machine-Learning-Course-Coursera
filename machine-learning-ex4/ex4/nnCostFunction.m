...
for i=1:m,
	...
	first = -yy.*log(hx);
	second = -(ones(num_labels,1)-yy).*log(ones(num_labels,1)-hx);
	
	J = J + sum(first+second);
end;
...
for i=1:m,
	...
	deltaL1 = deltaL1 + del2*a1';
	deltaL2 = deltaL2 + del3*a2';

end;

Theta1_grad = deltaL1/m;
Theta2_grad = deltaL2/m;
